...
namespace LeavePlannerApp2.Migrations
{
    ...
    [Migration("20181013074740_ApprovalANDRejections")]
    partial class ApprovalANDRejections
    {
            ...
            modelBuilder.Entity("LeavePlannerApp2.Models.ApprovalANDRejection", b =>
                {
                    ...
                    b.HasOne("LeavePlannerApp2.Models.LeaveApplication", "LeaveApplication")
                        .WithOne("GetApprovalANDRejection")
                        .HasForeignKey("LeavePlannerApp2.Models.ApprovalANDRejection", "LeaveApplicationId")
                        .OnDelete(DeleteBehavior.Cascade);
                });
